...
class _homeState extends State<home> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Center(child: Text("My calculator",style: const TextStyle(color: Colors.black, fontSize: 40))),backgroundColor: Colors.white),
            ...
            children: [
              ...
              Expanded(
                child: Container(
                    ...
                    child: Text("$input\n$final_result",style: TextStyle(fontSize: 50, fontWeight: FontWeight.normal,color: Colors.lightGreenAccent))
